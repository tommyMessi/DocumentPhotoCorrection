        ...
        for i in index:
            try:
                ...
                if np.random.rand() < background_ratio:
                    ...
                    vertex_resize_ratio_3_x = resize_w / float(vertex_new_w)
                    resize_ratio_3_y = resize_h/float(new_h)
                    vertex_resize_ratio_3_y = resize_h / float(vertex_new_h)
                    text_polys[:, :, 0] *= resize_ratio_3_x
                    vertex_text_polys[:, :, 0] *= vertex_resize_ratio_3_x
                    vertex_1_text_polys[:, :, 0] *= vertex_resize_ratio_3_x
                    vertex_2_text_polys[:, :, 0] *= vertex_resize_ratio_3_x
                    vertex_3_text_polys[:, :, 0] *= vertex_resize_ratio_3_x
                    vertex_4_text_polys[:, :, 0] *= vertex_resize_ratio_3_x
                    text_polys[:, :, 1] *= resize_ratio_3_y
                    vertex_text_polys[:, :, 1] *= vertex_resize_ratio_3_y
                    vertex_1_text_polys[:, :, 1] *= vertex_resize_ratio_3_y
                    vertex_2_text_polys[:, :, 1] *= vertex_resize_ratio_3_y
                    vertex_3_text_polys[:, :, 1] *= vertex_resize_ratio_3_y
                    vertex_4_text_polys[:, :, 1] *= vertex_resize_ratio_3_y

                    new_h, new_w, _ = im.shape
                    vertex_new_h, vertex_new_w, _ = vertex_im.shape
                    score_map, geo_map, training_mask = generate_rbox((new_h, new_w), text_polys, text_tags)
                    #wait a minite
                    vertex_score_map, vertex_geo_map, vertex_training_mask = generate_rbox((vertex_new_h, vertex_new_w), vertex_text_polys, vertex_text_tags)
                    vertex_1_score_map, vertex_1_geo_map, vertex_1_training_mask = generate_rbox((vertex_new_h, vertex_new_w), vertex_1_text_polys, vertex_1_text_tags)
                    vertex_2_score_map, vertex_2_geo_map, vertex_2_training_mask = generate_rbox((vertex_new_h, vertex_new_w), vertex_2_text_polys, vertex_2_text_tags)
                    vertex_3_score_map, vertex_3_geo_map, vertex_3_training_mask = generate_rbox((vertex_new_h, vertex_new_w), vertex_3_text_polys, vertex_3_text_tags)
                    vertex_4_score_map, vertex_4_geo_map, vertex_4_training_mask = generate_rbox((vertex_new_h, vertex_new_w), vertex_4_text_polys, vertex_4_text_tags)
                ...
                if 0:
                    ...
                    axs[0, 1].imshow(vertex_1_score_map[::, ::])
                    axs[0, 1].set_xticks([])
                    axs[0, 1].set_yticks([])
                    axs[1, 0].imshow(vertex_2_geo_map[::, ::, 0])
                    axs[1, 0].set_xticks([])
                    axs[1, 0].set_yticks([])
                    axs[1, 1].imshow(vertex_3_geo_map[::, ::, 1])
                    axs[1, 1].set_xticks([])
                    axs[1, 1].set_yticks([])
                    axs[2, 0].imshow(vertex_4_geo_map[::, ::, 2])
                    axs[2, 0].set_xticks([])
                    axs[2, 0].set_yticks([])
                ...
                vertex_score_maps.append(vertex_score_map[::4, ::4, np.newaxis].astype(np.float32))
                vertex_geo_maps.append(vertex_geo_map[::4, ::4, :].astype(np.float32))
                vertex_training_masks.append(vertex_training_mask[::4, ::4, np.newaxis].astype(np.float32))

                vertex_1_score_maps.append(vertex_1_score_map[::4, ::4, np.newaxis].astype(np.float32))
                vertex_1_geo_maps.append(vertex_1_geo_map[::4, ::4, :].astype(np.float32))
                vertex_1_training_masks.append(vertex_1_training_mask[::4, ::4, np.newaxis].astype(np.float32))

                vertex_2_score_maps.append(vertex_2_score_map[::4, ::4, np.newaxis].astype(np.float32))
                vertex_2_geo_maps.append(vertex_2_geo_map[::4, ::4, :].astype(np.float32))
                vertex_2_training_masks.append(vertex_2_training_mask[::4, ::4, np.newaxis].astype(np.float32))

                vertex_3_score_maps.append(vertex_3_score_map[::4, ::4, np.newaxis].astype(np.float32))
                vertex_3_geo_maps.append(vertex_3_geo_map[::4, ::4, :].astype(np.float32))
                vertex_3_training_masks.append(vertex_3_training_mask[::4, ::4, np.newaxis].astype(np.float32))

                vertex_4_score_maps.append(vertex_4_score_map[::4, ::4, np.newaxis].astype(np.float32))
                vertex_4_geo_maps.append(vertex_4_geo_map[::4, ::4, :].astype(np.float32))
                vertex_4_training_masks.append(vertex_4_training_mask[::4, ::4, np.newaxis].astype(np.float32))


                if len(images) == batch_size:
                    yield images, image_fns, score_maps, geo_maps, training_masks, vertex_score_maps, vertex_geo_maps, vertex_training_masks, vertex_1_score_maps, vertex_1_geo_maps, vertex_1_training_masks, vertex_2_score_maps, vertex_2_geo_maps, vertex_2_training_masks, vertex_3_score_maps, vertex_3_geo_maps, vertex_3_training_masks, vertex_4_score_maps, vertex_4_geo_maps, vertex_4_training_masks
                    images = []
                    image_fns = []
                    score_maps = []
                    geo_maps = []
